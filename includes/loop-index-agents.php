...
if ( $quote = get_post_meta($the_id, '_hl_agent_quote', true) ){
    $quote_author = get_post_meta($the_id, '_hl_quote_author', true);
    $content_output .= '<blockquote>';
    $content_output .= apply_filters('the_content', $quote);
    if ( $quote_author ) $content_output .= '- '.$quote_author;
    $content_output .= '</blockquote>';
}
                ...
                echo get_post_meta( get_the_id(), '_hl_title', true );
